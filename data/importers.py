...
import os
#import progressbar as pb # conflicts with tensorflow-gpu
import struct
...
class MSRA15Importer(DepthImporter):
    ...
    def loadSubSequence(self, subSeq, seqName=None, Nmax=float('inf'), suffle=False, rng=None, docom=False, cube=None):
        pass

    def loadSequence(self, seqName, subSeq=None, Nmax=float('inf'), shuffle=False, rng=None, docom=False, cube=None) -> NamedImgSequence:
        """
